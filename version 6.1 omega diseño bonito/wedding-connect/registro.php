...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nombre) || empty($correo) || empty($telefono) || empty($fecha_evento) || empty($tipo_evento_id)) {
        ...
        $hoy->setTime(0, 0, 0); // Asegurar que compare solo fechas, sin horas
        $fecha = DateTime::createFromFormat('Y-m-d', $fecha_evento);
        if ($fecha) {
            $fecha->setTime(0, 0, 0); // Asegurar que compare solo fechas, sin horas
        }
        if (!$fecha || $fecha < $hoy) {
                        ...
                        <div class="card-body p-5">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="correo" class="form-label fw-bold text-uppercase small">
                                                <i class="bi bi-envelope-paper-heart-fill me-2"></i> Correo electrónico *
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="telefono" class="form-label fw-bold text-uppercase small">
                                                <i class="bi bi-telephone-inbound-fill me-2"></i> Teléfono *
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="fecha_evento" class="form-label fw-bold text-uppercase small">
                                                <i class="bi bi-calendar2-heart-fill me-2"></i> Fecha del evento *
                                            </label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="tipo_evento_id" class="form-label fw-bold text-uppercase small">
                                                <i class="bi bi-stars me-2"></i> Tipo de evento *
                                            </label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="mensaje" class="form-label fw-bold text-uppercase small">
                                                <i class="bi bi-chat-square-heart-fill me-2"></i> Mensaje adicional
                                            </label>
                            ...
                            <div class="mt-5 text-center">
                                <p class="text-muted mb-4">
                                    <i class="bi bi-info-circle me-2"></i> Todos los campos marcados con * son obligatorios
                                </p>
                            </div>
                        </div>
                    </div>
