    ...
    <div class="modal-dialog">
        <div class="modal-content modal-nuevo">
            ...
            <div class="modal-footer-nuevo">
                ...
                <a href="mailto:<?php echo $cliente['correo']; ?>" class="btn btn-primary-nuevo">Contactar</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-nuevo">
            ...
            <div class="modal-footer-nuevo">
                ...
                <a href="mailto:<?php echo $ultimo_evento['correo']; ?>" class="btn btn-primary-nuevo">Contactar</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-nuevo">
            ...
            <div class="modal-footer-nuevo">
                ...
                <a href="mailto:<?php echo $proximo_evento['correo']; ?>" class="btn btn-primary-nuevo">Contactar</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
