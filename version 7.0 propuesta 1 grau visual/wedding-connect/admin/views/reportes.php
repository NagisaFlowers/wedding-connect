<?php
// admin/views/reportes.php - Vista de reportes OPTIMIZADA
?>
<!-- Agregar Chart.js -->
    ...
    <div class="col-lg-12">
        <div class="table-container-nuevo animate-nuevo">
            <div class="table-header-nuevo">
                <h4><i class="bi bi-bar-chart-fill"></i> Distribución por Tipo de Evento (Gráfico)</h4>
                <div class="btn-group gap-2">
                    <button class="btn btn-outline-nuevo" onclick="exportarGrafico()">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <canvas id="graficoBarras" style="width:100%; max-height:400px;"></canvas>
                </div>
            </div>
        </div>
    </div>
...
<!-- TABLA DE DISTRIBUCIÓN DETALLADA (ÚNICA) -->
<div class="table-container-nuevo animate-nuevo">
    <div class="table-header-nuevo">
        <h4><i class="bi bi-pie-chart-fill"></i> Distribución por Tipo de Evento (Detalle)</h4>
        <div class="btn-group gap-2">
                ...
                ?>
                    <tr>
                        ...
                        <td data-sort="<?php echo $porcentaje; ?>">
                            <div class="progress" style="height: 20px; background: rgba(88, 4, 99, 0.93);">
