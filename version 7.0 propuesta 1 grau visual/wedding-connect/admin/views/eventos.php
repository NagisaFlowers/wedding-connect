...
<div class="table-container-nuevo animate-nuevo" style="margin-bottom: 30px;">
                        ...
                        <div class="eventos-mini-nuevo">
                            ...
                            foreach ($eventos_dia as $evento): 
                                ...
                                if ($fecha_evento_solo < $hoy_dt) {
                                    ...
                                    $estado_clase = 'evento-mini-programado'; // azul
                                }
                                $contador++;
                            ?>
    ...
    <div class="calendario-leyenda-nuevo">
        <div class="leyenda-item">
            <span class="leyenda-color" style="background: var(--color-primary);"></span>
    ...
    <?php else: ?>
        ...
        <div class="mt-3 text-center">
            <small class="text-muted">
                ...
                <span class="badge badge-primary-nuevo" style="margin: 0 5px;"><i class="bi bi-calendar-heart" color: solid #1653fa;></i> Programado</span>
