<?php
// admin/views/clientes.php - Vista de clientes CON BUSCADOR
?>
<div class="table-container-nuevo animate-nuevo">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <div class="input-group" style="width: 250px;">
                ...
                <input type="text" 
                       ...
                       id="buscadorClientes" 
                       placeholder="Buscar por nombre, email, teléfono o evento..."
            ...
            <button class="btn btn-outline-nuevo" onclick="exportarClientesExcel()">
                <i class="bi bi-file-earmark-excel"></i> Exportar
            </button>
            <button class="btn btn-outline-nuevo" onclick="imprimirTablaClientes()">
    ...
    <?php else: ?>
        ...
        <div class="mb-2 text-muted small" id="resultadosBusqueda">
            Mostrando <span id="mostrandoCount"><?php echo count($datos['clientes']); ?></span> de <?php echo count($datos['clientes']); ?> clientes
        </div>
                ...
                <tbody>
                    <?php foreach ($datos['clientes'] as $cliente): ?>
                        <tr data-id="<?php echo $cliente['id']; ?>" 
                            ...
                            data-correo="<?php echo $cliente['correo']; ?>" 
                            data-telefono="<?php echo $cliente['telefono']; ?>" 
                            data-tipo="<?php echo $cliente['tipo_evento_id']; ?>" 
                            data-fecha="<?php echo $cliente['fecha_evento']; ?>" 
                            data-mensaje="<?php echo htmlspecialchars($cliente['mensaje'] ?? ''); ?>">
                            ...
                            <td data-sort="<?php echo strtolower(htmlspecialchars($cliente['nombre'])); ?>">
                                <div class="d-flex align-items-center">
                                    ...
                                    <strong class="nombre-cliente"><?php echo htmlspecialchars($cliente['nombre']); ?></strong>
                                </div>
                            </td>
                            ...
                            <td data-sort="<?php echo strtolower($cliente['tipo_nombre']); ?>">
                                ...
                                ?>
                                <span class="badge <?php echo $badge_class; ?> tipo-evento">
