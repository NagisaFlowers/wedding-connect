...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-completar mensaje basado en tipo de boda
    const tipoBodaSelect = document.getElementById('tipo_boda');
    const mensajeTextarea = document.getElementById('mensaje');
    
    if (tipoBodaSelect && mensajeTextarea) {
        tipoBodaSelect.addEventListener('change', function() {
